...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(sql
     ...
     emacs-lisp
     git
     ;; use ivy instead of helm for now
     ;;ivy
     helm
     ibuffer
     javascript
   ...
   dotspacemacs-additional-packages '(flymake-ruff
                                      ruff-format)
...
before packages are loaded."
  ...
  (setq-default
   ...
   ;; display-fill-column-indicator at column 80
   ...
   ;; Python
   python-shell-interpreter "/Users/nils/.asdf/shims/python"
   python-shell-interpreter-args ""
   flycheck-python-pycompile-executable "/Users/nils/.asdf/shims/python"
   flycheck-python-flake8-executable "/opt/homebrew/bin/ruff"
